...
| DF-06 | Operational Manual v3.0 §12 (settlement cycle); §4.4 buy-order step 7; §5.1 contract-note content | The settlement cycle is printed inconsistently — §12 headline and the failed-settlement clause say **T+2**, while §12.1 cheque release, §4.4 step 7, and §5.1 all say **T+3** — and both figures are now stale. | NGX equities/commodities settlement is **T+1**, effective **1 June 2026** (the market moved T+3 → T+2 on 28 Nov 2025 → T+1 on 1 Jun 2026). Standardize the Op Manual settlement cycle to **T+1** throughout. | Batch 2 (OPS-101; web-verified 06 Jun 2026) | OPEN |
| DF-07 | Operational Manual v3.0 §5.2 (contract-note issuance); §4.4 step 8 | Contract-note issuance is stated as **"within 24 hours of trade execution."** | Under the T+1 reform, contract notes are issued **the same day** as execution. Update §5.2 and §4.4 step 8 to **same-day issuance**. | Batch 2 (OPS-101; web-verified 06 Jun 2026) | OPEN |

*Append new rows as authoring proceeds. Resolve in a batched doc-refresh once Batch 1–4 LMS content is published.*
