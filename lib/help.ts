...
export const HELP: Record<string, HelpEntry> = {
  ...
  "learning/modules/[moduleId]": {
    ...
    viewPerm: "learning.view",
    purpose: `One module in detail — its description, materials, and who's enrolled or completed. Enroll yourself, or (for People Ops) manage its content and records.`,
    audience: `Everyone views & enrolls; People Ops manages content & records.`,
    actions: [
    ...
    related: ["learning", "learning/modules/[moduleId]/edit", "learning/my"],
    tutorialSection: "Learning & development",
  },
  "learning/modules/[moduleId]/edit": {
